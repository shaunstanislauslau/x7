...
// * @author Sim
// */
//public class DaoImpl_BAK implements Dao {
//
//	private static DaoImpl_BAK instance;
//
//	public static DaoImpl_BAK getInstance() {
//		if (instance == null) {
//			instance = new DaoImpl_BAK();
//		}
//		return instance;
//	}
//
...
//
//			List<Map<String, Object>> mapList = DaoImpl_BAK.getInstance().list(x7.repository.monitor.mysql.Process.class,
//					sql, null);
//
